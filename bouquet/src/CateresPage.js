...
function App() {
  return (
    <div className="App">
          ...
          <img className="phonebar1" src={require('./suplierimg/Phonebarwhite.png')} alt="phonebar image"/> 
        <img className="supplierscards1" src={require('./suplierimg/cheff.png')} alt="Music image"/>  
        ...
        <p>Reviews
        <img className="groupstars" src={require('./suplierimg/groupstars.png')} alt="phonebar image"/>
